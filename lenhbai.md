# “Lệnh bài” 
## cùng chính phủ quét sạch covid trong vùng dịch.
...
1) 2 người tới gửi xe vào chợ, có dám chắc là họ từ 2 gia đình? 
...
**Thẻ gia đình**: có thông tin khu vực. Mặt sau có con dấu xác nhận của Phường / Xã đang sống. Khi đưa thẻ tới tưng  gia đình, cán bộ Phường/ xã sẽ nhập địa chỉ thông qua mobileapp riêng. 
**Thẻ đi làm**: có chỗ để ghi tay số cmnd, cccd của người được cấp. khi bị kiểm tra, cần đưa thêm cmnd, cccd trùng với số này. 
Mặt sau có con dấu đơn vị làm việc, con dấu xác nhận của của chính  quyền cấp cho đơn vị
**Thẻ chống dịch** màu đỏ để đội ngũ y tế, cán bộ phường, tham gia điều tiết lấy mẫu xét nghiệm, chống dịch. 
Cần nhập số điện thoại vào hệ thống để gọi điện từ xa.

**Lưu ý**: 
- Thẻ gia đình, Thẻ đi làm cho phép hoạt động mà không cần cung cấp thông tin cá nhân, riêng tư. 
- mã qrcode là tính năng nâng cao, dùng cho công an kiểm tra, quét tại checkpoint, đưa cho nhân viên chợ, siêu thị kiểm tra,...
- qrcode không cần với người dân.


Hai công năng chính của “lệnh bài” là “vô thức” hạn chế hoạt động của mọi người và bảo đảm mọi gia đình, mọi cá nhân khác (mang thẻ đi làm, đi công vụ) thường xuyên được xét nghiệm. 

### 1. “vô thức” hạn chế hoạt động hàng ngày của mọi người

Hạn chế hoạt động của mọi người là 
- giảm số di chuyển trong ngày của tất cả cư dân” trong 1 khu vực (Phường / Xã) , 
- đồng thời vùng hoạt động (di chuyển, tụ tập) được co cụm trong một khu vực nhất định.

> Quan trọng nhất là mọi người sẽ hạn chế một cách “vô thức”, không dựa vào ý thức tự giác của mỗi người.
...
**Dịch covid là 1 cấu  trúc hệ thống**
 ...
 Trong đó “lây qua tiếp xúc, có khả năng lây sau 2,3 ngày và thời gian ủ bệnh tới 14-21 ngày,…” là 1 cấu trúc, và hệ thống ở đây là việc tiếp xúc, di chuyển của mọi người trong việt nam và cả thế giới. 
...
Mọi người đeo khẩu trang khi tiếp xúc là 1 cấu trúc hệ thống hạn chế lây lan 
